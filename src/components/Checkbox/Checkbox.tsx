import React, { FC, InputHTMLAttributes, useMemo, memo } from 'react';
...
const Checkbox: FC<CheckboxProps> = memo(({
    ...
    const styles = useMemo(() => {
        ...
        return { ...style, '--checkbox_background': fill };
    }, [fill, style]);
    ...
    const bodyView = useMemo(() => {
        ...
        return <span className="Checkbox__container D(ib) margin-aqua--left" children={children} />;
    }, [children]);
